...
def gui3():
    ...
    bg2 = PhotoImage(file = "white.png")
    canvas3 = Canvas( root3, width = 900, 
                    height = 900 ) 
    canvas3.pack(fill = "both", expand = True) 
    canvas3.create_image( 0, 0, image = bg2, 
                        anchor = "nw")
    canvas3.create_text( 50, 10, text = "Welcome",fill="maroon",font=("Franklin Gothic Medium", "12"),anchor="n")
